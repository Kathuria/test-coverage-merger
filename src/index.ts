 ...
 */
export const testCoverageMerger = ({
  rootPath = 'test-reports',
  mergedLcovFileName = 'merged-report',
  outputHtmlFileName = 'final-report',
  coverageReports,
}: {
  rootPath?: string;
  mergedLcovFileName?: string;
  outputHtmlFileName?: string;
  coverageReports: Array<string>;
}) => {
